...
use crate::mqtt::{MqttError, COMBINED_CA_FILES_PATH};
use paho_mqtt::{
    ConnectOptions, ConnectOptionsBuilder, CreateOptions, CreateOptionsBuilder, Message,
...
impl MqttOptions {
    ...
    fn build_ssl_options(
        ...
        if !trust_store.exists() {
            ...
            return Err(anyhow::Error::from(MqttError::FileNotFound(
